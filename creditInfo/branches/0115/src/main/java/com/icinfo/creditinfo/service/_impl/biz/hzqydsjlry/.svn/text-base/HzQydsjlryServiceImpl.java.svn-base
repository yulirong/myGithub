 ...
 * @version 1.0
 */
package com.icinfo.creditinfo.service._impl.biz.hzqydsjlry;
...
/**
 * 
 * 描述: 董事经理人 Service 实现<br>
 * @author gqf
 * @date 2015-04-13
 */
public class HzQydsjlryServiceImpl extends HxBaseServiceImpl<HzQydsjlry> implements HzQydsjlryService
{
	/**
	 * 描述：获取所有高管人员信息
	 * 
	...
	public List<HzQydsjlry> doGetAllHzQyDsjlr(Map<String, Object> qryMap) throws Exception{
		return doGetHzQydsjlryDao().doSelectAllHzQyDsjlr(qryMap);
	}
	/**
	 * 描述：获取所有的企业投资人信息
	 * 
	...
	public List<HzQydsjlry> doGetHzQydsjlryListForRelation(Map<String, Object> qryMap) throws Exception{
		return doGetHzQydsjlryDao().doSelectHzQydsjlryListForRelation(qryMap);
	}
	/**
	 * 描述：获取高管信息
	 * 
	...
	public List<HzQydsjlry> doGetHzQydsjlryList(Map<String, Object> qryMap) throws Exception{
		return doGetHzQydsjlryDao().doSelectHzQydsjlryListForEntBaseInfo(qryMap);
	}
	/**
	 * 描述：获取高管人数
	 * 
	...
	public Integer doGetTotalForRelation(Map<String, Object> qryMap) throws Exception{
		return doGetHzQydsjlryDao().doGetTotalForRelation(qryMap);
	}
	public HzQydsjlryDao doGetHzQydsjlryDao()
	{
		return (HzQydsjlryDao)hxBaseDao;
	}
}
