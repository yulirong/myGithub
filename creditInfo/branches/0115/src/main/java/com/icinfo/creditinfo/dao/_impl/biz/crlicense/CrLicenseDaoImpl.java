 ...
 * @version 1.0
 */
package com.icinfo.creditinfo.dao._impl.biz.crlicense;
 ...
 * @date 2015-10-22
 */
public class CrLicenseDaoImpl extends HxBaseDaoImpl<CrLicense> implements CrLicenseDao
{
    /**
     * 
     * 描述: 查询状态
	...
	public List<String> selectStateList() throws Exception {
		return (List<String>)getBaseSqlMapDao().queryForList("ibatis-crlicense.selectStateList");
	}
