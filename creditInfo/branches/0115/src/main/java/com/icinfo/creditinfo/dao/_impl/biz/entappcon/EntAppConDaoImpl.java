 ...
 * @date 2015-01-23
 */
public class EntAppConDaoImpl extends HxBaseDaoImpl<EntAppConInfo> implements EntAppConDao
{
	/**
	 * 描述: 获取企业核准内容列表
	 * 
	...
	public List<EntAppConInfo> selectEntAppConInfoListForIndex(
		...
		return (List<EntAppConInfo>)getBaseSqlMapDao().queryForList("ibatis-entappcon.selectEntAppConInfoListForIndex", qryMap);
	}
