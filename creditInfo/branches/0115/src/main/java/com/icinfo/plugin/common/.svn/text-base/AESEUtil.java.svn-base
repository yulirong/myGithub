...
public class AESEUtil {
	...
	public static String decryptContext(String param) throws UnsupportedEncodingException {
		...
		return new String(AESEUtil.decrypt(AESEUtil.parseHexStr2Byte(param), HxConstants.SECRET_KEY),"utf-8");
	}
	...
	public static String encryptContext(String param) {
		return new String(AESEUtil.parseByte2HexStr(AESEUtil.encrypt(param,HxConstants.SECRET_KEY)));
	}
