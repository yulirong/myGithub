 ...
 * @version 1.0
 */
package com.icinfo.creditinfo.dao._impl.upload.tempwaterpay;
 ...
 * @date 2015-11-12
 */
public class TempWaterPayDaoImpl extends HxBaseDaoImpl<TempWaterPay> implements TempWaterPayDao
{
